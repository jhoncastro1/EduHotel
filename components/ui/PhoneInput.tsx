...
>(({ className, type, ...props }, ref) => (
    <input
        type={type}
        className={cn(
            "w-full flex-1 items-center gap-3 rounded-2xl border border-zinc-200 px-4 py-3 transition focus-within:border-[#166b6b]",
            className
        )}
        ref={ref}
        {...props}
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="relative ">
                        <Button
                            ...
                            disabled={disabled}
                            className={cn(
                                "flex items-center gap-3 rounded-2xl border border-zinc-200 px-4 py-3 transition focus-within:border-[#166b6b]",
